...
class ParentChildRecyclerviewFragment : Fragment() {
    ...
    private fun loadRecyclerView(parentChildParentML: MutableList<RVParentChildParentItemDC>){
        ...
        binding.rvParent.adapter = ParentChildParentRVAdapter(parentChildParentML){selectedPageCode: String -> childListItemClicked(selectedPageCode)}
    }
    ...
    private fun childListItemClicked(selectedPageCode: String) {
        ...
        if (selectedPageCode == "" || selectedPageCode == "PC_General_Entry_01_PC" ){
            ...
            questionsFrameworkItem.questionsFrameworkTitle = aInfo5ViewModel.extractDisplayNameFromPageCode(selectedPageCode)
            ...
            questionsFrameworkDataItem.questionsFrameworkTitle = questionsFrameworkItem.questionsFrameworkTitle
            ...
            observationsCheckboxesFrameworkItem.checkboxesFrameworkTitle = aInfo5ViewModel.extractDisplayNameFromPageCode(selectedPageCode)
            ...
            observationsFrameworkDataItem.checkboxesFrameworkTitle = observationsCheckboxesFrameworkItem.checkboxesFrameworkTitle
            ...
            recommendationsCheckboxesFrameworkItem.checkboxesFrameworkTitle = aInfo5ViewModel.extractDisplayNameFromPageCode(selectedPageCode)
            ...
            sectionPageFramework.recommendationsFrameworkList.add(recommendationsCheckboxesFrameworkItem)

            recommendationsFrameworkDataItem.checkboxesFrameworkTitle = recommendationsCheckboxesFrameworkItem.checkboxesFrameworkTitle
            recommendationsFrameworkDataItem.pageCode = selectedPageCode
            sectionPageData.recommendationsFrameworkDataItemList.add(recommendationsFrameworkDataItem)

            standardsCheckboxesFrameworkItem.checkboxesFrameworkTitle = aInfo5ViewModel.extractDisplayNameFromPageCode(selectedPageCode)
            ...
            standardsFrameworkDataItem.checkboxesFrameworkTitle = standardsCheckboxesFrameworkItem.checkboxesFrameworkTitle
